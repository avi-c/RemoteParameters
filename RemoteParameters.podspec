...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Avi Cieplinski"
  # spec.authors            = { "Avi Cieplinski" => "avi@avic.co" }
  ...
  spec.source = { :git => "https://github.com/avi-c/RemoteParameters.git", :tag => "#{s.version}" }
  ...
  # spec.frameworks = "MultipeerConnectivity", "RxCocoa", "RxSwift"
